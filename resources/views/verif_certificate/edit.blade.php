    ...
    <div class="py-8 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow rounded-lg">
                <form action="{{ route('verif-certificates.update', $certificate->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex items-center gap-4">
                        <label for="UDIN" class="{{ $labelClass }}">UDIN</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="UDIN" id="UDIN" class="{{ $inputClass }}"
                            value="{{ $certificate->UDIN }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="cn" class="{{ $labelClass }}">CN</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="cn" id="cn" class="{{ $inputClass }}"
                            value="{{ $certificate->cn }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="iec" class="{{ $labelClass }}">IEC</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="iec" id="iec" class="{{ $inputClass }}"
                            value="{{ $certificate->iec }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="firm_name" class="{{ $labelClass }}">Firm Name</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="firm_name" id="firm_name" class="{{ $inputClass }}"
                            value="{{ $certificate->firm_name }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="scheme" class="{{ $labelClass }}">Scheme</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="scheme" id="scheme" class="{{ $inputClass }}"
                            value="{{ $certificate->scheme }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="process" class="{{ $labelClass }}">Process</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="process" id="process" class="{{ $inputClass }}"
                            value="{{ $certificate->process }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="date" name="doi_of_document" id="doi_of_document" class="{{ $inputClass }}"
                            value="{{ $certificate->doi_of_document }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="doc_type" class="{{ $labelClass }}">Document Type</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="doc_type" id="doc_type" class="{{ $inputClass }}"
                            value="{{ $certificate->doc_type }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="issuing_office" id="issuing_office" class="{{ $inputClass }}"
                            value="{{ $certificate->issuing_office }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="current_status" id="current_status" class="{{ $inputClass }}"
                            value="{{ $certificate->current_status }}">
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_application_number" id="ecd_application_number"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_application_number }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="ecd_scheme_name" class="{{ $labelClass }}">Scheme Name</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="ecd_scheme_name" id="ecd_scheme_name"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_scheme_name }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_exporter_name" id="ecd_exporter_name"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_exporter_name }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_exporter_address" id="ecd_exporter_address"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_exporter_address }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_exporter_country" id="ecd_exporter_country"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_exporter_country }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_importer_name" id="ecd_importer_name"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_importer_name }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_importer_address" id="ecd_importer_address"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_importer_address }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_importer_country" id="ecd_importer_country"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_importer_country }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_status" id="ecd_status" class="{{ $inputClass }}"
                            value="{{ $certificate->ecd_status }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="ecd_means_of_transport_and_route" class="{{ $labelClass }}">Transport &
                            Route</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="ecd_means_of_transport_and_route"
                            id="ecd_means_of_transport_and_route" class="{{ $inputClass }}"
                            value="{{ $certificate->ecd_means_of_transport_and_route }}">
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_invoice_details" id="ecd_invoice_details"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_invoice_details }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_application_file_by" id="ecd_application_file_by"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_application_file_by }}"
                            required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_place_of_authorised_signatory"
                            id="ecd_place_of_authorised_signatory" class="{{ $inputClass }}"
                            value="{{ $certificate->ecd_place_of_authorised_signatory }}" required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_certified_issued_by" id="ecd_certified_issued_by"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_certified_issued_by }}"
                            required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_place_of_certifying_authority"
                            id="ecd_place_of_certifying_authority" class="{{ $inputClass }}"
                            value="{{ $certificate->ecd_place_of_certifying_authority }}" required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="ecd_certified_issuing_agency" class="{{ $labelClass }}">Issuing Agency</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="text" name="ecd_certified_issuing_agency" id="ecd_certified_issuing_agency"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_certified_issuing_agency }}"
                            required>
                    </div>

                    <div class="flex items-center gap-4">
                        <label for="ecd_certified_issued_on" class="{{ $labelClass }}">Issued On</label>
                        <label class="{{ $labelTitikDua }}">:</label>
                        <input type="date" name="ecd_certified_issued_on" id="ecd_certified_issued_on"
                            class="{{ $inputClass }}" value="{{ $certificate->ecd_certified_issued_on }}"
                            required>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="ecd_certified_country_of_origin"
                            id="ecd_certified_country_of_origin" class="{{ $inputClass }}"
                            value="{{ $certificate->ecd_certified_country_of_origin }}" required>
                    </div>
