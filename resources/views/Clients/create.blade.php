                ...
                <form @submit.prevent="submitForm()" class="space-y-6">
                    ...
                    <div class="form-control">
                        ...
                        <input 
                            ...
                            @input="clearErrors('requester_name')"
                    ...
                    <div class="form-control">
                        ...
                        <textarea 
                            ...
                            @input="clearErrors('problem_detail')"
                        ...
                        <div class="label">
                            ...
                            <span x-show="errors.problem_detail" class="label-text-alt text-error" x-text="errors.problem_detail?.[0]"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <textarea 
                            ...
                            @input="clearErrors('definition_of_done')"
                            class="textarea textarea-bordered h-32"
                        ...
                        <div class="label">
                            ...
                            <span x-show="errors.definition_of_done" class="label-text-alt text-error" x-text="errors.definition_of_done?.[0]"></span>
                        </div>
                    </div>
